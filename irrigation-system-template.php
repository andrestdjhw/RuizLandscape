<?php
/**
 * Template Name: Service — Irrigation Systems
 * Template Post Type: page
 *
 * SEO (configúralo en tu plugin de SEO / Yoast / Rank Math):
 *   Title:       Irrigation System Installation in Orange County | Ruiz Landscape
 *   Description: Water-wise irrigation system design, installation & repair in Orange, LA &
 *                Imperial counties. Conserve water and keep your landscape healthy. Free consultation.
 *   Keywords:    irrigation system installation Orange County, drip irrigation Irvine,
 *                sprinkler system repair Orange County, water-wise irrigation Southern California,
...
══════════════════════════════════════════════ */
$ir_images = array(
  'hero-bg' => '/wp-content/uploads/2026/06/Irrigation-scaled.jpg', // fondo del hero
);

/* ── Qué incluye (Sección 2) ── */
$ir_included = array(
  array( 't' => 'Irrigation system design',        'd' => 'Tailored to your landscape and its watering needs.' ),
  array( 't' => 'Professional installation',        'd' => 'Efficient systems installed with care and precision.' ),
  array( 't' => 'Drip irrigation',                  'd' => 'Water-wise watering delivered right to the roots.' ),
  array( 't' => 'Smart controllers and scheduling', 'd' => 'Automated scheduling built for conservation.' ),
  array( 't' => 'Repairs and maintenance',          'd' => 'Keeping your existing system running at its best.' ),
  array( 't' => 'Seasonal adjustments',             'd' => 'Plus leak detection to catch waste early.' ),
);

/* ── FAQ (Sección 3) ── */
$ir_faqs = array(
  array(
    'q' => 'Can a new system actually save me water?',
    'a' => "Yes. Efficient design, drip irrigation, and smart controllers can significantly reduce water use while keeping your landscape healthy — it's central to our water-wise approach.",
  ),
  array(
    'q' => 'Do you repair existing irrigation systems?',
    'a' => 'We do — repairs, leak detection, and seasonal adjustments on existing systems, in addition to new installations.',
  ),
  array(
    'q' => 'Do you install drip irrigation?',
    'a' => 'Yes. Drip irrigation is one of the most efficient options for water-wise planting, and we install and maintain it regularly.',
  ),
);
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.ruizlandscape.com/services/irrigation-systems/#service",
      "name": "Irrigation Systems",
      "serviceType": "Irrigation System Installation and Repair",
      "url": "https://www.ruizlandscape.com/services/irrigation-systems",
      "description": "Water-wise irrigation system design, installation & repair in Orange, LA & Imperial counties. Conserve water and keep your landscape healthy.",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Irrigation Systems", "item": "https://www.ruizlandscape.com/services/irrigation-systems" }
      ]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Can a new system actually save me water?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. Efficient design, drip irrigation, and smart controllers can significantly reduce water use while keeping your landscape healthy — it's central to our water-wise approach." }
        },
        {
          "@type": "Question",
          "name": "Do you repair existing irrigation systems?",
          "acceptedAnswer": { "@type": "Answer", "text": "We do — repairs, leak detection, and seasonal adjustments on existing systems, in addition to new installations." }
        },
        {
          "@type": "Question",
          "name": "Do you install drip irrigation?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. Drip irrigation is one of the most efficient options for water-wise planting, and we install and maintain it regularly." }
        }
      ]
    }
  ]
...
#rl-svc .rsv-hero-bg {
  position: absolute;
  inset: 0;
  background-image: url('<?php echo esc_url( $ir_images['hero-bg'] ); ?>');
...
<section class="rsv-hero">
  ...
  <div class="rsv-hero-content">
    ...
    <h1 class="rsv-reveal">Water-wise irrigation that keeps your <span>landscape lush.</span></h1>
    <p class="rsv-hero-sub rsv-reveal">
      Maximize the efficiency of your water usage with professional irrigation solutions designed
      to conserve water while keeping your landscape lush and healthy — efficient by design,
      installed and maintained with care.
    </p>
...
<section class="rsv-section rsv-included">
  <div class="rsv-container">
    ...
    <div class="rsv-incl-grid">
      <?php foreach ( $ir_included as $item ) : ?>
