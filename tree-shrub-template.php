<?php
/**
 * Template Name: Service — Tree & Shrub Care
 * Template Post Type: page
 *
 * SEO (configúralo en tu plugin de SEO / Yoast / Rank Math):
 *   Title:       Tree & Shrub Care in Orange County, CA | Ruiz Landscape Service
 *   Description: Professional tree and shrub care in Orange, LA & Imperial counties — pruning,
 *                trimming, disease management & removal. Keep your landscape healthy.
 *   Keywords:    tree and shrub care Orange County, tree trimming Irvine,
 *                tree pruning service Southern California, shrub care Orange County,
 *                tree removal Irvine CA
 */
...
$ts_included = array(
  array( 't' => 'Pruning and trimming',           'd' => 'For the health and shape of your trees and shrubs.' ),
  array( 't' => 'Disease and pest management',     'd' => 'Diagnosing and treating problems before they spread.' ),
  array( 't' => 'Hedge and shrub shaping',         'd' => 'Clean, defined lines that keep plantings looking their best.' ),
  array( 't' => 'Safe tree removal',               'd' => 'Professional removal when a tree needs to come out.' ),
  array( 't' => 'Health assessments',              'd' => 'Expert evaluation of your mature trees.' ),
  array( 't' => 'Seasonal care',                   'd' => 'Ongoing attention to keep plantings thriving year-round.' ),
);

/* ── FAQ (Sección 3) ── */
$ts_faqs = array(
  array(
    'q' => 'Do you handle tree removal?',
    'a' => 'Yes — safe, professional tree removal is part of our tree care service, along with pruning, trimming, and disease management.',
  ),
  array(
    'q' => 'How often should trees and shrubs be pruned?',
    'a' => "It depends on the species and goals, but most benefit from at least annual care. We'll assess your plantings and recommend a schedule during a consultation.",
  ),
  array(
    'q' => 'Can you treat a tree that looks unhealthy?',
    'a' => 'Yes. We provide disease and pest management and health assessments to help save and restore struggling trees and shrubs where possible.',
  ),
);
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.ruizlandscape.com/services/tree-shrub-care/#service",
      "name": "Tree & Shrub Care",
      "serviceType": "Tree and Shrub Care",
      "url": "https://www.ruizlandscape.com/services/tree-shrub-care",
      "description": "Professional tree and shrub care in Orange, LA & Imperial counties — pruning, trimming, disease management & removal.",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Tree & Shrub Care", "item": "https://www.ruizlandscape.com/services/tree-shrub-care" }
      ]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you handle tree removal?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes — safe, professional tree removal is part of our tree care service, along with pruning, trimming, and disease management." }
        },
        {
          "@type": "Question",
          "name": "How often should trees and shrubs be pruned?",
          "acceptedAnswer": { "@type": "Answer", "text": "It depends on the species and goals, but most benefit from at least annual care. We'll assess your plantings and recommend a schedule during a consultation." }
        },
        {
          "@type": "Question",
          "name": "Can you treat a tree that looks unhealthy?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. We provide disease and pest management and health assessments to help save and restore struggling trees and shrubs where possible." }
        }
      ]
    }
  ]
...
#rl-svc .rsv-hero-bg {
  position: absolute;
  inset: 0;
  background-image: url('<?php echo esc_url( $ts_images['hero-bg'] ); ?>');
...
<section class="rsv-hero">
  ...
  <div class="rsv-hero-content">
    ...
    <h1 class="rsv-reveal">Professional tree and shrub care <span>for a healthier landscape.</span></h1>
    <p class="rsv-hero-sub rsv-reveal">
      We provide professional tree and shrub care — pruning, trimming, disease management, and
      removal — to ensure the health, beauty, and safety of the plants that give your landscape
      its structure and shade.
    </p>
...
<section class="rsv-section rsv-included">
  <div class="rsv-container">
    ...
    <div class="rsv-incl-grid">
      <?php foreach ( $ts_included as $item ) : ?>
