      ...
      <footer className="rl-footer">
        ...
        <div className="rl-footer-cta">
          ...
          <a href="/contact" className="rl-footer-cta-btn">
            Request a Free Estimate <ArrowRight />
          </a>
        </div>
        ...
        <div className="rl-footer-body">
          ...
          <div className="rl-footer-brand">
            ...
            <div className="rl-footer-socials">
              <a href="https://www.google.com/search?q=Ruiz+Landscape+Service%2C+Inc.&oq=Ruiz+Landscape+Service%2C+Inc.&sourceid=chrome&ie=UTF-8" target="_blank" rel="noreferrer"
                className="rl-footer-social-btn" aria-label="Google Business Profile">
                <GoogleIcon />
              </a>
              ...
              <a href="https://www.tiktok.com/@ruizlandscapeserviceinc" target="_blank" rel="noreferrer"
                className="rl-footer-social-btn" aria-label="TikTok">
                <TikTokIcon />
              </a>
