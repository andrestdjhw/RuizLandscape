...
const GoogleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24">
    ...
    <path fill="#EA4335" d="M12 4.77c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.27 6.63l4 3.1C6.22 6.88 8.87 4.77 12 4.77z"/>
  </svg>
)
      ...
      <nav className={`rl-navbar ${scrolled ? "scrolled" : ""}`} style={{ boxShadow: scrolled ? undefined : 'none' }}>
        ...
        <div className="rl-topbar">
          ...
          <div className="rl-topbar-right">
            <a href="https://www.google.com/search?q=Ruiz+Landscape+Service%2C+Inc.&oq=Ruiz+Landscape+Service%2C+Inc.&sourceid=chrome&ie=UTF-8" target="_blank" rel="noreferrer" className="rl-social-link" aria-label="Google Business Profile">
              <GoogleIcon />
            </a>
            ...
            <a href="https://www.tiktok.com/@ruizlandscapeserviceinc" target="_blank" rel="noreferrer" className="rl-social-link" aria-label="TikTok">
              <TikTokIcon />
            </a>
        ...
        <div className="rl-mainnav">
              ...
              <div className={`rl-mega ${servicesOpen ? "open" : ""}`}>
                <div className="rl-mega-inner">
                  ...
                  <div className="rl-mega-feature">
                    ...
                    <a href="/contact" className="rl-mega-btn" onClick={() => setServicesOpen(false)}>Request a Free Estimate</a>
          ...
          <div className="rl-nav-right">
            <a href="/contact" className="rl-nav-link cta rl-contact-desktop">Request a Free Estimate</a>
        ...
        <div className={`rl-mobile-menu ${mobileOpen ? "open" : ""}`}>
          <div className="rl-mobile-menu-inner">
            ...
            <a href="/contact" className="rl-mobile-cta" onClick={() => setMobileOpen(false)}>Request a Free Estimate</a>
          </div>
        </div>
      </nav>
    </>
