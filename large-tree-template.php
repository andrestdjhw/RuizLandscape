<?php
/**
 * Template Name: Service — Large Tree Installation
 * Template Post Type: page
 *
 * SEO (configúralo en tu plugin de SEO / Yoast / Rank Math):
 *   Title:       Large Tree Installation in Orange County | Ruiz Landscape Service
 *   Description: Mature shade and specimen tree installation in Orange, LA & Imperial counties.
 *                Expert species selection and precise installation. Free consultation.
 *   Keywords:    large tree installation Southern California, mature tree planting Orange County,
 *                specimen tree installation Irvine, shade tree installation,
 *                tree planting service Orange County
 */
...
$lt_included = array(
  array( 't' => 'Species selection guidance',      'd' => 'Choosing the right tree for your site and goals.' ),
  array( 't' => 'Sourcing mature trees',            'd' => 'Quality shade trees and specimen trees, sourced for you.' ),
  array( 't' => 'Professional installation',        'd' => 'The right equipment and technique for each tree.' ),
  array( 't' => 'Site and soil preparation',        'd' => 'Setting the foundation for healthy establishment.' ),
  array( 't' => 'Placement planning',               'd' => 'For shade, privacy, and design impact.' ),
  array( 't' => 'Establishment and follow-up care', 'd' => 'Guidance to help each tree thrive in its new home.' ),
);

/* ── FAQ (Sección 3) ── */
$lt_faqs = array(
  array(
    'q' => 'Can you install fully mature trees?',
    'a' => 'Yes. We specialize in installing large, mature trees — with the right equipment and technique to give each specimen the best chance to thrive.',
  ),
  array(
    'q' => 'How do I choose the right tree?',
    'a' => 'We help you select the right species for your site, climate, and goals — whether you want shade, privacy, or a striking focal point.',
  ),
  array(
    'q' => 'Will the tree survive the move?',
    'a' => "Proper species selection, site prep, and installation technique are everything. Our experience is focused on maximizing each tree's chance of establishing successfully.",
  ),
);
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.ruizlandscape.com/services/large-tree-installation/#service",
      "name": "Large Tree Installation",
      "serviceType": "Large Tree Installation",
      "url": "https://www.ruizlandscape.com/services/large-tree-installation",
      "description": "Mature shade and specimen tree installation in Orange, LA & Imperial counties. Expert species selection and precise installation.",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Large Tree Installation", "item": "https://www.ruizlandscape.com/services/large-tree-installation" }
      ]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Can you install fully mature trees?",
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. We specialize in installing large, mature trees — with the right equipment and technique to give each specimen the best chance to thrive." }
        },
        {
          "@type": "Question",
          "name": "How do I choose the right tree?",
          "acceptedAnswer": { "@type": "Answer", "text": "We help you select the right species for your site, climate, and goals — whether you want shade, privacy, or a striking focal point." }
        },
        {
          "@type": "Question",
          "name": "Will the tree survive the move?",
          "acceptedAnswer": { "@type": "Answer", "text": "Proper species selection, site prep, and installation technique are everything. Our experience is focused on maximizing each tree's chance of establishing successfully." }
        }
      ]
    }
  ]
...
#rl-svc .rsv-hero-bg {
  position: absolute;
  inset: 0;
  background-image: url('<?php echo esc_url( $lt_images['hero-bg'] ); ?>');
...
<section class="rsv-hero">
  ...
  <div class="rsv-hero-content">
    ...
    <h1 class="rsv-reveal">Large tree installation, done with <span>precision and care.</span></h1>
    <p class="rsv-hero-sub rsv-reveal">
      From towering shade trees to majestic specimens, we work closely with you to select the
      perfect species for your needs — then install each tree with the precision and care that
      gives it the best chance to thrive in its new home.
    </p>
...
<section class="rsv-section rsv-included">
  <div class="rsv-container">
    ...
    <div class="rsv-incl-grid">
      <?php foreach ( $lt_included as $item ) : ?>
