 ...
 *   Title:       Landscape Design & Installation in Orange County | Ruiz Landscape
 *   Description: Custom eco-friendly landscape design and installation in Orange, LA & Imperial
 *                counties. Water-wise gardens and outdoor living spaces. Free consultation.
 *   Keywords:    landscape design Orange County, landscape installation Irvine,
 *                xeriscape design Southern California, water-wise garden design,
 *                outdoor living space design Orange County
 */
...
$ld_included = array(
  array( 't' => 'Custom landscape design',            'd' => 'Full-property concepts balancing beauty, function, and sustainability.' ),
  array( 't' => 'Water-wise and xeriscape designs',   'd' => "Drought-tolerant plantings built for California's climate." ),
  array( 't' => 'Garden installation',                'd' => 'Lush, layered planting designs with established, healthy specimens.' ),
  array( 't' => 'Outdoor living spaces',              'd' => 'Patios, hardscape, water features, and gathering areas.' ),
  array( 't' => 'Hardscape and water features',       'd' => 'Integrated stone, pavers, and fountains.' ),
  array( 't' => 'Full installation',                  'd' => 'From grading and soil prep to planting, irrigation, and finishing.' ),
);
...
$ld_faqs = array(
  array(
    ...
    'a' => 'Yes. We design your landscape and our own crews install it — one accountable team from first sketch to finished space.',
  ),
  array(
    'q' => 'Can you make my landscape more water-efficient?',
    'a' => 'Absolutely. Water-wise and xeriscape design is one of our specialties — drought-tolerant planting, efficient irrigation, and smart material choices that cut water use without sacrificing beauty.',
  ),
  array(
    'q' => 'How does the process work?',
    'a' => 'It starts with a free consultation to understand your vision and space. We then develop a design, refine it with you, and install it with clear communication throughout.',
  ),
);
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Service",
      "@id": "https://www.ruizlandscape.com/services/landscape-design-installation/#service",
      ...
      "description": "Custom eco-friendly landscape design and installation in Orange, LA & Imperial counties. Water-wise gardens and outdoor living spaces.",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Landscape Design & Installation", "item": "https://www.ruizlandscape.com/services/landscape-design-installation" }
      ]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "Yes. We design your landscape and our own crews install it — one accountable team from first sketch to finished space." }
        },
        {
          "@type": "Question",
          "name": "Can you make my landscape more water-efficient?",
          "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. Water-wise and xeriscape design is one of our specialties — drought-tolerant planting, efficient irrigation, and smart material choices that cut water use without sacrificing beauty." }
        },
        {
          "@type": "Question",
          "name": "How does the process work?",
          "acceptedAnswer": { "@type": "Answer", "text": "It starts with a free consultation to understand your vision and space. We then develop a design, refine it with you, and install it with clear communication throughout." }
        }
      ]
    }
  ]
...
#rl-svc .rsv-hero-bg {
  position: absolute;
  inset: 0;
  background-image: url('<?php echo esc_url( $ld_images['hero-bg'] ); ?>');
...
<section class="rsv-hero">
  ...
  <div class="rsv-hero-content">
    ...
    <h1 class="rsv-reveal">Landscape design and installation,<br><span>built around your vision.</span></h1>
    <p class="rsv-hero-sub rsv-reveal">
      From lush gardens and inviting outdoor living spaces to sustainable xeriscapes and water-wise
      designs, our team brings your outdoor vision to life with creativity, expertise, and
      eco-conscious materials — then installs it with the craftsmanship a beautiful landscape deserves.
    </p>
